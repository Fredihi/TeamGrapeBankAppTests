...
namespace TeamGrapeBankApp
{
    public class LoanAccount : BankAccount
    {
        ...
        public static void TakeLoan(User loggedInCustomer)
        {
            Console.Clear();
        ...
        public static decimal LoanLimit(User loggedInCustomer, List<BankAccount> Accounts)
        {
            decimal totalBalance = 0;
            List<BankAccount> LoggedInUserBankAccounts = Accounts.FindAll(x => x.Owner == loggedInCustomer.Username);
